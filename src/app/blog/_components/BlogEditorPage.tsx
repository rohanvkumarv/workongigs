  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-blue-50/50 to-white">
      ...
      <div className="max-w-7xl mx-auto p-6 pt-24">
        ...
        >
          <a href="/blog/new-blog" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-white px-4 py-2 rounded-xl shadow-md hover:shadow-lg transition-all text-blue-600 hover:text-blue-800">
            <ArrowLeft size={18} />
            <span>Back to Blog Info</span>
          </a>
          <a href="/blog/blog-preview" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-xl shadow-md hover:shadow-lg hover:bg-blue-700 transition-all">
            <Eye size={18} />
            <span>Preview</span>
          </a>
        </motion.div>
