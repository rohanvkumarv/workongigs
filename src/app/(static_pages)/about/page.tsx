...
//         >
//           <div className="inline-flex items-center justify-center gap-2 text-sm font-medium bg-black/5 text-black/80 px-4 py-2 rounded-full mb-4">
...
//             About Us
//           </h1>
//           <p className="text-sm text-gray-600">Learn more about who we are and what we stand for.</p>
//         </motion.div>
...
//         >
//           <div className="relative bg-white rounded-3xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-gray-100 overflow-hidden p-8 sm:p-12">
...
//                 Welcome to WorkOnGigs, a platform designed to empower freelancers and simplify collaboration between clients and freelancers. We provide tools that streamline project management, ensure secure payments, and create an effortless workflow.
//               </p>
...
//               </h2>
//               <p className="text-gray-700 leading-relaxed">
//                 Our mission is to enable freelancers to focus on delivering exceptional work by providing a hassle-free platform for managing projects and payments. We aim to make freelancing stress-free and productive.
//               </p>
...
//                 <li>
//                   <strong>Streamlined Project Management:</strong> Organize and track your projects effortlessly.
//                 </li>
//                 <li>
//                   <strong>Secure Payment System:</strong> Ensure payments are made before delivering work.
//                 </li>
//                 <li>
//                   <strong>Freelancer-Centric Design:</strong> Built for freelancers who collaborate through WhatsApp and email.
//                 </li>
//               </ul>
...
//               </h2>
//               <p className="text-gray-700 leading-relaxed">
//                 We invite you to join WorkOnGigs and experience a platform crafted to simplify your freelancing journey. Let us handle the logistics while you focus on delivering great work.
//               </p>
...
//                 <li>Email: <a href="mailto:contact@workongigs.com" className="text-blue-500 underline">contact@workongigs.com</a></li>
//                 <li>Phone: +917477211211</li>
...
//                   {[
//                     { title: 'Streamlined Project Delivery', desc: 'Keep track of what s delivered and what s pending.' },
