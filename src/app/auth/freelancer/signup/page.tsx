...
//                   type="password"
//                   placeholder="Confirm Password"
//                   className={`w-full p-3.5 rounded-2xl border bg-white focus:outline-none ${formData.confirmPassword && formData.password !== formData.confirmPassword ? 'border-red-300 focus:border-red-400' : 'border-gray-200 focus:border-gray-300'}`}
//                   value={formData.confirmPassword}
//                   onChange={(e) => setFormData({...formData, confirmPassword: e.target.value})}
//                 />
...
//     } else {
//       alert('Invalid OTP or failed to create user');
//     }
//   };
...
//   const handleSubmit = () => {
//     if (step === 1) {
//       handleSendOtp(); // Send OTP on first submit
//     } else if (step === 2) {
//       handleVerifyOtp(); // Verify OTP and create user
//     }
//   };
...
//             <div
//               onClick={handleSubmit}
//               className={`px-6 py-2.5 rounded-2xl transition-colors cursor-pointer ${(!formData.email || !formData.password || !formData.confirmPassword || formData.password !== formData.confirmPassword) ? 'bg-gray-300 cursor-not-allowed' : 'bg-black text-white hover:bg-gray-800'}`}
//             >
//               Next step
//             </div>
//           )}
