...
//                   {/* Display uploaded files - Above file drop, compact */}
...
//   // File upload tracking for new delivery
...
//   // Handle files being selected/dropped
...
//                     }`}>
//                       {uploadErrors.length > 0 
//                         ? `❌ ${uploadErrors.length} file(s) failed. ${uploadedFiles.length} uploaded.`
//                         : isUploadingFiles 
//                           ? `📤 Uploading... (${uploadedFiles.length}/${totalFilesSelected})`
//                           : allFilesUploaded 
//                             ? `✅ All ${uploadedFiles.length} file(s) uploaded!`
//                             : `⏳ ${uploadedFiles.length}/${totalFilesSelected} files uploaded`
//                       }
//                     </div>
//                   )}
...
//                     !canSubmit || !newDeliveryForm.name.trim() || !newDeliveryForm.cost
