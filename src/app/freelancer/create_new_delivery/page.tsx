...
// import { Info, Hash, Copy, Check, X, Search } from 'lucide-react';
...
//         const link = `/${selectedClient.id}/delivery/${result.delivery.id}`;
...
//         <p className="text-gray-600 mb-6 md:mb-8">Select a client and set up delivery information</p>
