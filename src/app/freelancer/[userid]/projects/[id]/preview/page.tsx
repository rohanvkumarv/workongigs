...
//             className={`px-8 py-3 rounded-2xl text-base font-medium transition-all duration-300 flex items-center gap-2
...
//         {!isSingleInstance && instancePrice > 0 && (
//           <>
...
//         {remainingInstances} instance{remainingInstances !== 1 ? 's' : ''} remaining
//       </p>
//     </div>
...
//                     ${isSingleInstance || !instancePrice
//                       ? 'bg-black text-white'
//                       : 'bg-gray-100 text-gray-700 hover:bg-gray-200'}`}
//         >
//           <Package className="w-5 h-5" />
//           Pay for Remaining Instances (₹{projectPrice})
//         </motion.button>
//       )}
//     </div>
//   </div>
...
//   const handlePayInstance = async () => {
//     // Implement payment logic here
//     const updatedInstances = [...projectData.instances];
//     updatedInstances[selectedInstance] = {
//       ...updatedInstances[selectedInstance],
//       paymentStatus: "Paid"
//     };
...
//   // Calculate total price for unpaid instances only
...
//   // Get files from paid instances only
//   const paidFiles = projectData.instances
//     .filter(instance => instance.paymentStatus === "Paid")
...
//                       instancePrice={currentInstance.cost}
//                       description={currentInstance.desc}
//                       onPayInstance={handlePayInstance}
//                       onPayProject={handlePayProject}
//                       isSingleInstance={isSingleInstance}
//                       remainingInstances={unpaidInstances.length}
//                     />
//                   </motion.div>
//                 ) : (
//                   <motion.div
...
//                       downloadAllLabel="Download Instance Files"
//                     />
//                   </motion.div>
//                 )}
//               </AnimatePresence>
...
//     handlePayment(currentInstance.cost, currentInstance.id, false);
//   };

//   const handlePayProject = () => {
//     handlePayment(totalProjectPrice, null, true);
//   };
